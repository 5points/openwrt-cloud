...
git clone --depth=1 https://github.com/Lienol/openwrt-package lienol-package
rm -rf ../lean/lienol-package/luci-app-kodexplorer
...
svn co https://github.com/gd0772/package/trunk/theme/luci-theme-opentomcat
